  ...
  return (
    <div>
      <div className=" max-w-7xl  mx-auto px-4 py-6">
        <Link
          to={"/app"}
          className=" inline-flex items-center text-slate-500 hover:text-slate-700 transition-all"
        >
          ...
          <div className=" relative lg:col-span-5 rounded-lg overflow-hidden">
            <div className=" bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
              ...
              <div className=" flex justify-between items-center mb-6 border-b border-gray-300 py-1">
                {/* accent colour and Template Change Options */}
                <div className=" flex  items-center gap-2 ">
                  <TemplateSelector
                    selectedTemplate={resumeData.template}
                    onChange={(data) => {
                      setResumeData((prev) => ({ ...prev, template: data }));
                    }}
                  />
                  <ColourPicker
                    selectedColor={resumeData.accent_color}
                    onChange={(data) =>
                      setResumeData((prev) => ({ ...prev, accent_color: data }))
                    }
                  />
                </div>
