    ...
    <div>
      <div className=" max-w-7xl mx-auto px-4 py-8">
        <p className=" text-2xl font-medium mb-6 bg-gradient-to-r from-slate-600 to-slate-700 bg-clip-text text-transparent sm:hidden">
          Welcome, Abhisekh Suru
        </p>
        {/* Section for upload and create */}
          ...
          {allResumes.map((resume, index) => {
            ...
            return (
              ...
              >
                ...
                <p
                  className=" absolute bottom-1 text-[11px] text-slate-600 group-hover:text-slate-800 transition-all duration-300 px-2 text-center"
                  style={{ color: baseColor + "100" }}
                >
