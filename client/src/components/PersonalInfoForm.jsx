        ...
        {typeof data.image === "object" && (
          <div className=" flex flex-col gap-1 pl-4 text-sm">
            ...
            <label className=" relative inline-flex items-center cursor-pointer text-gray-900 gap-3">
              ...
              <span className=" dot absolute left-1 top-1 w-3 h-3 bg-white rounded-full transition-transform duration-200 ease-in-out peer peer-checked:translate-x-4"></span>
            </label>
          </div>
        )}
      </div>
