    ...
    <div className=" space-y-4">
      ...
      <div className=" mt-6">
        <textarea
          ...
          rows={7}
          className=" w-full p-3 mt-2 border text-sm border-gray-300 rounded-lg focus:ring focus:ring-blue-500  outline-none transition-colors resize-none "
          placeholder="Write a compelling professional summary that highlights your key strengths and career objectives..."
        />
        <p className=" text-xs text-gray-600 max-w-4/5 mx-auto text-center">
